...
const ChoosePayment = ({ bookingId, bookingData }) => {
  ...
  const {
    changeBookingPaymentMutation: { mutate, isPending },
  } = useBookingMutations();
  ...
  const paymentOptions = [
    ...
    },
    {
      ...
      buttonStyle:
        "bg-gradient-to-r from-blue-500 to-indigo-500 text-white duration-500",
    },
  ];
    ...
    <div className="bg-white rounded-3xl shadow border-t border-gray-100 p-8 sticky top-[163px]">
      ...
      <div className="space-y-4 mb-6">
        {paymentOptions.map((option) => {
          ...
          const isCurrentlyProcessing = isPending && isSelected;
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Your booking is confirmed regardless of payment method</li>
              <li>
